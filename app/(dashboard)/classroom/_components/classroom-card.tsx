    ...
    >
      <div className="p-6">
        <div className="flex items-start justify-between mb-4">
          ...
          <Badge
            variant="secondary"
            className="bg-pink-50 text-pink-600 border-0"
          >
        ...
        <p className="text-sm text-gray-500">{classroom.courseType}</p>
      </div>

      {/* Decorative wave pattern */}
      <div
        className={`absolute bottom-0 right-0 w-32 h-32 bg-gradient-to-br ${
          colorClasses[classroom.color]
        } rounded-tl-full opacity-50`}
      />
    </Card>
  );
}
